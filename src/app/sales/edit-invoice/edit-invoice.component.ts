...
@Component({
  ...
  templateUrl: '../add-edit-invoice/add-edit-invoice.component.html',
  styleUrls: ['../add-edit-invoice/add-edit-invoice.component.scss']
})
export class EditInvoiceComponent implements OnInit ,OnChanges{
  ...
  clearform() {
    ...
    this.Invoicecategory = "goodsInvoice";//SEDT
  }
